all:
	...
	gcc -c -m32 src/x86_64/kernel/filesystem/impl/USTAR.c -ffreestanding -fno-pie -fstack-protector -o obj/ustar.o
	gcc -c -m32 src/x86_64/kernel/drivers/impl/mouse.c -ffreestanding -fno-pie -fstack-protector -o obj/mouse.o
